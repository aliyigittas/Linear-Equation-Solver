...
int main(){
	...
	char newline[20];
	strcpy(newline, lines[0]); // this is to turn lines[0] which is the first equation to a new string to measure its length easily.
...
printf("The constant is %f", coefficients_control[i]);
